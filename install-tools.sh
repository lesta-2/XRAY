...
# ==================================================
# Link Hosting Kalian
WISANGvpn="raw.githubusercontent.com/lesta-2/install/main/ssh"
...
curl https://raw.githubusercontent.com/lesta-2/ssh/main/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/lesta-2/ssh/main/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/lesta-2/ssh/main/index.html1"
